...
NIFTY1000_LIST_URL = "https://archives.nseindia.com/content/indices/ind_nifty1000list.csv"
# "nifty1000" (default, ~1000 liquid stocks) or "all" (every NSE-listed equity, ~2000+)
UNIVERSE = os.environ.get("UNIVERSE", "nifty1000")
